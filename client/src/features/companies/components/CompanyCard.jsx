...
// Not a Link yet, deliberately — there's no Company Details route in
// this batch. Wiring navigation before that page exists is exactly
// what caused the CS Subjects Step 3/4 gap confusion; adding it here
// waits until a details page actually exists to receive it.
