      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          {company.logoUrl ? (
            ...
            <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-primary-muted font-display text-[14px] font-semibold text-primary-strong">
        ...
        {company.website && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex shrink-0 items-center gap-1.5 text-[13px] font-medium text-primary-strong hover:underline"
          >
            Website
        ...
        {company.interviewRounds?.length > 0 && (
          <Card className="p-5">
            ...
            <ol className="mt-3 space-y-2.5">
              {company.interviewRounds.map(
                (round, i) => (
                  <li
                    key={round}
                    className="flex items-center gap-3 text-[13.5px] text-text-muted"
                  >
